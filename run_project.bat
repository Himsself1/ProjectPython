...
::part 2
py python_project.py --vcf chr22_100000_lines.vcf --sample_filename sample_information.csv --action VALIDATE_SAMPLE_INFO
...
py python_project.py --vcf 1kgp_chr1.vcf --sample_filename sample_information.csv --population GWD 100 --population YRI 200 --SNPs 500 --output outputfile.vcf --action SIMULATE --independent 300 --population IBS 300 --MINIMUM_AF 0.3
::part 6
...
::part 8
py python_project.py --vcf chr22_100000_lines.vcf --sample_filename sample_information.csv --population FIN 100 --population YRI 200 --action FIND_RATIO --independent 100 --MINIMUM_AF 0.1 --iterations 2
